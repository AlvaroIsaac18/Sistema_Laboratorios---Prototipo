...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group" data-filter-group="estado">
            ...
            <button class="btn btn-outline-success btn-sm filter-btn" data-filter-group="estado" data-filter-value="aprobada">Aprobadas</button>
            <button class="btn btn-outline-danger btn-sm filter-btn" data-filter-group="estado" data-filter-value="rechazada">Rechazadas</button>
        </div>
    </div>
                ...
                <?php if (!empty($solicitudes)): ?>
                    ...
                    <tr data-estado="<?= $estado ?>">
                        ...
                        <td>
                            ...
                            <span class="badge bg-light text-dark border"><i class="bi bi-geo-alt me-1"></i><?= htmlspecialchars($lab) ?></span>
                        </td>
                        <td>
                            <span class="d-block"><i class="bi bi-calendar me-1"></i> <?= date('d M Y', strtotime($s['fechaSolicitudPractica'] ?? 'now')) ?></span>
