...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body p-4 p-md-5">
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-md-6">
                <label class="fw-semibold text-secondary small">Observación</label>
                <p class="fs-6"><?= htmlspecialchars($solicitud['observacionSolicitudPractica'] ?? 'Sin observación') ?></p>
            </div>
            <div class="col-md-6">
        ...
        <h5 class="fw-bold mb-3 text-primary border-bottom pb-2">Fecha y Horario</h5>
        <div class="row g-4 mb-5">
            <div class="col-md-4">
                <label class="fw-semibold text-secondary small">Fecha Propuesta</label>
                <p class="fs-6"><?= date('d \d\e M \d\e\l Y', strtotime($solicitud['fechaSolicitudPractica'] ?? 'now')) ?></p>
            </div>
            <div class="col-md-4">
                <label class="fw-semibold text-secondary small">Hora Inicio</label>
                <p class="fs-6"><?= $solicitud['horaInicioSolicitudPractica'] ? date('h:i A', strtotime($solicitud['horaInicioSolicitudPractica'])) : 'N/A' ?></p>
            </div>
            <div class="col-md-4">
                <label class="fw-semibold text-secondary small">Hora Fin</label>
                <p class="fs-6"><?= $solicitud['horaFinSolicitudPractica'] ? date('h:i A', strtotime($solicitud['horaFinSolicitudPractica'])) : 'N/A' ?></p>
            </div>
        </div>
