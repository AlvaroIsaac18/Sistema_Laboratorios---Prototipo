...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group" data-filter-group="estado">
            ...
            <button class="btn btn-outline-primary btn-sm filter-btn" data-filter-group="estado" data-filter-value="activa">Ocupado</button>
            <button class="btn btn-outline-warning btn-sm filter-btn" data-filter-group="estado" data-filter-value="pendiente">Pendiente</button>
            <button class="btn btn-outline-success btn-sm filter-btn" data-filter-group="estado" data-filter-value="aprobada">Aprobada</button>
            <button class="btn btn-outline-secondary btn-sm filter-btn" data-filter-group="estado" data-filter-value="finalizada">Finalizada</button>
            <button class="btn btn-outline-danger btn-sm filter-btn" data-filter-group="estado" data-filter-value="cancelada">Cancelada</button>
        </div>
    </div>
