                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseInsumos" class="accordion-collapse collapse <?php echo (in_array($activeRoute, ['insumo', 'reporte'])) ? 'show' : ''; ?>" aria-labelledby="headingInsumos"
                            ...
                            <div class="accordion-body p-0">
                                ...
                                <a href="index.php?url=Insumo&type=movimientos" class="nav-link py-2 ps-5 small <?php echo ($activeRoute === 'insumo' && ($_GET['type'] ?? '') === 'movimientos') ? 'active' : ''; ?>">Movimientos (Entradas/Salidas)</a>
