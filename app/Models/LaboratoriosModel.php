...
class LaboratoriosModel extends ConnectDB
{
    public function getAll()
    {
        ...
        $stmt = $conex->query("SELECT * FROM tbllaboratorio ORDER BY nomLaboratorio");
    ...
    public function create($data)
    {
        $conex = $this->getConnection();
        $stmt = $conex->prepare("
            INSERT INTO tbllaboratorio (tipoLaboratorio, capacidadLaboratorio, estadoLaboratorio, ubicacionLaboratorio, nomLaboratorio)
            VALUES (:tipo, :capacidad, :estado, :ubicacion, :nombre)
        ");
        $stmt->execute([
